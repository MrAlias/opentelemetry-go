...
const (
	...
	// ExponentBias is the exponent bias specified for encoding the IEEE 754
	// double-precision floating point exponent (i.e. 1023).
	ExponentBias = 1<<(ExponentWidth-1) - 1

	// ExponentMask are set to 1 for the bits of an IEEE 754 floating point
	// exponent (i.e. 0x7FF0000000000000).
	...
	// MinNormalExponent is the minimum exponent of a normalized floating
	// point (i.e. -1022).
	MinNormalExponent int32 = -ExponentBias + 1

	// MaxNormalExponent is the maximum exponent of a normalized floating
	// point (i.e. 1023).
