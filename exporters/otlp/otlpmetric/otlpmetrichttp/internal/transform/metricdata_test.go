...
// source: internal/shared/otlpmetric/transform/metricdata_test.go.tmpl
...
var (
	...
	otelGaugeZeroStartTime = metricdata.Gauge[int64]{DataPoints: []metricdata.DataPoint[int64]{
