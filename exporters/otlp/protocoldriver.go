...
import (
	...
	tracesdk "go.opentelemetry.io/otel/sdk"
...
type ProtocolDriver interface {
	...
	// take this into account by doing proper locking.
	ExportTraces(ctx context.Context, spans []tracesdk.ReadOnlySpan) error
}
...
func (d *splitDriver) ExportTraces(ctx context.Context, spans []tracesdk.ReadOnlySpan) error {
